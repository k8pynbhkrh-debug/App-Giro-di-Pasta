...
- Added centralized haptic feedback via `triggerHaptic(type)` in `/Users/eric/Projekte/GiroPastaNight-Web/app.js`
- Added a dedicated recap view after the last round in `/Users/eric/Projekte/GiroPastaNight-Web/index.html` and `/Users/eric/Projekte/GiroPastaNight-Web/app.js`
- Improved Apple Erinnerungen export with Web Share API support plus clipboard fallback in `/Users/eric/Projekte/GiroPastaNight-Web/app.js`
- Added a dedicated `Copy for Bring` export action in `/Users/eric/Projekte/GiroPastaNight-Web/index.html` and `/Users/eric/Projekte/GiroPastaNight-Web/app.js`

## Changed Files

- `/Users/eric/Projekte/GiroPastaNight-Web/app.js`
- `/Users/eric/Projekte/GiroPastaNight-Web/index.html`
- `/Users/eric/Projekte/GiroPastaNight-Web/FEATURE_IMPLEMENTATION_SUMMARY.md`
